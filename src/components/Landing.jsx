        ...
        {isAboveMediumScreens ? (
          ...
          >
            <motion.img
              ...
              alt="profile"
              src={profile}
              className="hover:saturate-200 rounded-t-[400px] transition duration-500 z-10
              max-w-[100px] w-[400px] h-[500px] object-cover object-right md:max-w-[600px]"
            />
          </div>
        ) : (
          <motion.img
            ...
            src={profile}
            className="hover:saturate-200 rounded-t-[400px] transition duration-500 z-10
              max-w-[360px] w-[400px] h-[500px] object-cover object-right md:max-w-[600px]"
          />
        )}
      </div>
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          >
            ...
            z-20 xs:before:content-brush before:absolute before:-left-[25px]
          ...
          <p className="mt-10 mb-7 text-sm text-center md:text-start">
            ...
            adipisci labore officia dicta veniam dolorum eveniet amet,
          </p>
        </motion.div>
        <motion.div
        ...
        >
          ...
          >
            ...
            duration-500 w-full h-full flex items-center justify-center font-playfair
            px-10 "
            >
              Let's talk
            </div>
